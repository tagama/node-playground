import {getDataAsObjects, requestUrls, responseAtributes} from '../../src/payments'

describe('payments', function () {

  it('should validade first result', function () {
    return getDataAsObjects(
      requestUrls.remuneracaoTodosMembrosAtivos,
      responseAtributes.remuneracaoTodosMembrosAtivos
    ).then((data) => {
      //console.log(data)
